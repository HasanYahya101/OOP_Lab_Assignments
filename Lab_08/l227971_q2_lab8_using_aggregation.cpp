...
Author::Author(const string &name, const string &email, char gender) : name(name), email(email), gender(gender) {}
...
public:
    Book(const string &name, Author *author, double price, int qtyInStock = 0);
    string getName() const;
...
Book::Book(const string &name, Author *author, double price, int qtyInStock) : name(name), author(author), price(price), qtyInStock(qtyInStock) {}
